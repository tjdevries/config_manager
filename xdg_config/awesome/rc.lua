...
local theme_ok = pcall(
  function()
    beautiful.init('/home/tj/build/powerarrow/themes/powerarrow/theme.lua')
...
local globalkeys = gears.table.join(
  awful.key(
    ...
    {modkey}, 'w', function() my_main_menu:show() end, {
      description = 'show main menu',
      group = 'awesome',
    }
  ), -- Layout manipulation
  awful.key(
    {modkey, mods.shift}, 'j', function() awful.client.swap.byidx(1) end,
    {description = 'swap with next client by index', group = 'client'}
  ), awful.key(
    {modkey, mods.shift}, 'k', function() awful.client.swap.byidx(-1) end,
  ...
  awful.key(
    ...
    {modkey, mods.shift}, 'q', awesome.quit, {
    ...
    {modkey, mods.shift}, 'h', function() awful.tag.incnmaster(1, nil, true) end,
    {description = 'increase the number of master clients', group = 'layout'}
  ), awful.key(
    {modkey, mods.shift}, 'l', function() awful.tag.incnmaster(-1, nil, true) end,
    ...
    {modkey, mods.shift}, 'space', function() awful.layout.inc(-1) end,
...
clientkeys = gears.table.join(
  awful.key(
    ...
    {modkey, mods.shift}, 'c', function(c) c:kill() end, {
      description = 'close',
      group = 'client',
    }
  ), awful.key(
    ...
    {modkey, mods.shift}, 'm', function(c)
...
for i = 1, 9 do
  globalkeys = gears.table.join(
    ...
    awful.key(
      {modkey, mods.shift}, '#' .. i + 9, function()
    ...
    awful.key(
      {modkey, 'Control', mods.shift}, '#' .. i + 9, function()
        if client.focus then
          local tag = client.focus.screen.tags[i]
